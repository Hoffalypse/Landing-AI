...
export default class Example extends Component {
  ...
  slides = [
    ...
    {
      key: 8,
      content: <a href='https://www.google.com'><img src="https://picsum.photos/805/800/?random" alt="8" /></a>
    }
  ].map((slide, index) => {
  ...
  render() {
    return (
      <div
        style={{ width: "80%", height: "500px", marginLeft:'auto', marginRight:'auto', marginTop:'150px' }}
